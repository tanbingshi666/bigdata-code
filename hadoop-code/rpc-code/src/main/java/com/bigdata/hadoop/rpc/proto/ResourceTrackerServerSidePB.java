...
public class ResourceTrackerServerSidePB implements ResourceTrackerPB {
  ...
  @Override
  public ResourceTrackerMessage.ResponseProto registerNodeManager(RpcController controller,
      ResourceTrackerMessage.RequestProto request) throws ServiceException {
    try {
