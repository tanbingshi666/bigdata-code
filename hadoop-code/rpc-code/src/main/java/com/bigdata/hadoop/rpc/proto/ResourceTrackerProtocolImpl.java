...
public class ResourceTrackerProtocolImpl implements ResourceTrackerProtocol {
  @Override
  public ResourceTrackerMessage.ResponseProto registerNodeManager(ResourceTrackerMessage.RequestProto request)
      throws Exception {
    // 构建一个响应对象，用于返回
    ResourceTrackerMessage.ResponseProto.Builder builder = ResourceTrackerMessage.ResponseProto.newBuilder();
